// resources.ts
// Import all resource images properly
import mentalResilienceImage from "@/assets/resources/mental-resilience.webp";
import customerMindsetsImage from "@/assets/resources/customer-mindsets.webp";
import agentWellbeingImage from "@/assets/resources/agent-wellbeing.webp";
import humansAndAiImage from "@/assets/resources/humans-and-ai.webp";
import fightDistractionsImage from "@/assets/resources/fightdistractions.webp";
import humanIntelligenceImage from "@/assets/resources/humanintelligence.webp";
import aiCopilotWarriorImage from "@/assets/resources/aicopilotwarrior.webp";
import frontlineHeroesImage from "@/assets/resources/frontlineheroes.webp";
import futureAiHumanImage from "@/assets/resources/futureaihuman.webp";
...
export const resources: Resource[] = [
  {
    ...
    content: [
      ...
      {
        type: "paragraph",
        text: "Customer support is always described as a 'people first' role — but let's be real: what about the people behind the replies?",
      },
      {
        type: "paragraph",
        text: "Support agents handle the frontline of human emotion — juggling tough conversations, tight SLAs, endless ticket queues, and product updates that change faster than you can say release notes.",
      },
      {
        type: "paragraph",
        text: "That constant load doesn't just challenge your skills… it drains your mental energy. And when your mental battery is empty, burnout is only a few tickets away.",
      },
      {
        type: "paragraph",
        text: "The good news? You can protect yourself — and your quality of work — with a few simple resilience habits.",
      },
      {
        type: "paragraph",
        text: "Here are five science-backed, field tested routines that keep you calm, sharp, and in control… even on those days.",
      },
      {
        type: "subheading",
        text: "1. The 90-Minute Focus Sprint (+ a Real Break)",
      },
      {
        type: "paragraph",
        text: "Why it works: Your brain naturally cycles through peaks of focus every ~90 minutes. Push past that, and productivity tanks while stress spikes.",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "paragraph",
        text: "Result: You'll feel more in control of your queue — and far less fried at the end of the day.",
      },
      {
        type: "subheading",
        text: "2. Emotional Checkpoints Before You Hit Send",
      },
      {
        type: "paragraph",
        text: "Why it works: Emotional labor is invisible but real. If you're stressed, tired, or frustrated, it seeps into your tone — and can make a ticket worse.",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "subheading",
        text: "3. Ticket Batching — Kill the Multitasking Myth",
      },
      {
        type: "paragraph",
        text: "Why it works: Multitasking feels productive, but it's really context switching — a proven productivity killer.",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "paragraph",
        text: "Result: Your brain stays in flow, errors go down, and you feel less scattered.",
      },
      { type: "subheading", text: "4. Micro Peer Check-ins" },
      {
        type: "paragraph",
        text: "Why it works: No one should carry the emotional weight of this job alone. A 5–10 minute chat with a teammate can release pressure and build connection.",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "paragraph",
        text: "Why it works: You don't need a two week vacation to recharge. Micro breaks keep your nervous system from running in overdrive.",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "paragraph",
        text: "Result: You'll head home lighter — and leave the ticket stress at your desk.",
      },
      { type: "heading", text: "Final Words" },
      {
        type: "paragraph",
        text: "Support work is tough — but it doesn't have to feel heavy. Pick one habit from this list and practice it daily. Then add another. Over time, these small changes will create a safety net for your mind, your mood, and your motivation.",
      },
      {
        type: "paragraph",
        text: "Because here's the truth: when support agents feel supported, customers feel it too. Every reply becomes more thoughtful, every conversation more human — and that's the kind of energy that keeps people coming back.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "paragraph",
        text: "If you've ever opened your inbox and somehow ended up watching \"Top 10 Cats Who Think They're Ninjas\" on YouTube… you're not alone.",
      },
      {
        type: "paragraph",
        text: "Modern support work is a constant balancing act — juggling tickets, calming frustrated customers, and answering pings that never seem to stop. Add to that the digital noise of today's world, and focus starts slipping away before you even notice.",
      },
      {
        type: "paragraph",
        text: "Here's the truth: focus isn't something you're born with — it's something you train, like a muscle. And the stronger it gets, the more you protect your time, energy, and sanity.",
      },
      {
        type: "paragraph",
        text: "Here are six battle-tested, support agent approved ways to protect your attention and work with more calm, clarity, and control.",
      },
      {
        type: "subheading",
        text: "🔁 1. Sprint, Then Breathe (The Gentle Pomodoro)",
      },
      {
        type: "paragraph",
        text: "Work in 25-minute deep-focus bursts followed by 5 minutes of genuine rest. After four rounds, take a longer break to truly recharge. You'll be amazed at how much mental clarity you get when your brain knows it only has to push for a short sprint before it rests.",
      },
      {
        type: "paragraph",
        text: "💡 Human Tip: Use a visible timer — it's like having a silent coach reminding you, \"We've got this.\"",
      },
      { type: "subheading", text: "🚫 2. Declutter Your Digital Universe" },
      {
        type: "paragraph",
        text: "Distractions hide in plain sight — your favorite news site, that tempting Instagram tab, or even Slack when you're not in active collaboration. Use tools like Freedom, Cold Turkey, or browser blockers to make distractions invisible during focus time.",
      },
      {
        type: "paragraph",
        text: "📌 Why it works: What you can't see, you won't chase. Out of sight, out of mind — and out of your mental space.",
      },
      { type: "subheading", text: "🎯 3. The Magic Rule of 3" },
      {
        type: "paragraph",
        text: "At the start of each day, choose only three high impact tasks. Not fifteen. Not everything in your inbox. Just the three that will make you feel proud at day's end.",
      },
      {
        type: "paragraph",
        text: "Everything else? Bonus points. This keeps you working with intention, not just reacting to whatever pops up.",
      },
      ...
      {
        type: "paragraph",
        text: 'Even in a bustling support floor, your environment can whisper, "This is your calm zone."',
      },
      { type: "subheading", text: "🔕 5. Tame the Ping Monster" },
      {
        type: "paragraph",
        text: "You don't have to be a slave to every notification. Turn off non essential alerts. Use Do Not Disturb during deep work blocks. Let colleagues know when you'll be fully available again.",
      },
      {
        type: "paragraph",
        text: "⏳ Truth: Urgency is often an illusion — most things can wait 20 minutes. Your brain deserves that peace.",
      },
      ...
      {
        type: "paragraph",
        text: "These little acts flush mental fatigue before it becomes burnout. Remember: rest is part of the job, not an interruption to it.",
      },
      { type: "subheading", text: "🧩 Final Word for Support Professionals" },
      {
        type: "paragraph",
        text: "Your job isn't just answering questions — it's carrying the weight of customers' frustrations and turning them into trust. That's emotional labor. That's skill. And that's why your focus needs protection.",
      },
      {
        type: "paragraph",
        text: "This week, try just one or two of these techniques. Notice the difference. Then build from there. And if you drift? That's okay. Focus is a living skill — it grows with kindness, patience, and practice.",
      },
    ],
    category: "Secret to Elevate Experience",
  },
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "paragraph",
        text: "Support engineers juggle complex cases, high expectations, and limited time. AI can change the game.",
      },
      {
        type: "paragraph",
        text: "Instead of replacing you, AI works as your co pilot — spotting trends, drafting replies, and providing instant data.",
      },

      { type: "subheading", text: "⚡ 1. Instant Knowledge Access" },
      {
        type: "paragraph",
        text: "AI can instantly pull the right KB resource or past ticket, cutting your resolution time in half.",
      },
      {
        type: "paragraph",
        text: "This means you no longer waste minutes (or hours) digging through documentation — the right answer is there before you finish reading the customer's message.",
      },

      { type: "subheading", text: "🔄 2. Automating the Boring Stuff" },
      {
        type: "paragraph",
        text: "From tagging tickets to sending follow ups, AI handles the repetitive so you can handle the remarkable.",
      },
      {
        type: "paragraph",
        text: "Think of it as offloading mental clutter. Every click AI does for you is one more click you can use to add value to the conversation.",
      },

      { type: "subheading", text: "🧩 3. AI as a Silent Partner" },
      {
        type: "paragraph",
        text: "Your AI co pilot never gets tired, never misses a pattern, and never forgets a single piece of historical context. It's the colleague who remembers everything.",
      },

      {
        type: "subheading",
        text: "🔍 Self Analysis: Where Are You Losing Time?",
      },
      {
        type: "paragraph",
        text: "Be brutally honest with yourself. Review your last 20 tickets — how much time did you spend searching for info, formatting replies, or doing repetitive admin? These are prime candidates for AI automation.",
      },

      {
        type: "subheading",
        text: "📈 Productivity Blueprint for the AI Enabled Engineer",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "paragraph",
        text: "AI doesn't just make support faster — it gives you back the time and energy to be the human customers remember.",
      },
      {
        type: "paragraph",
        text: "Your productivity isn't about working harder — it's about working with a partner who never sleeps, so you can focus on the parts of support that truly need a human brain and heart.",
      },
    ],
    category: "Secret to Elevate Experience",
  },
  {
    ...
    content: [
      ...
      {
        type: "paragraph",
        text: "Support engineers are modern day firefighters — but instead of hoses, they use empathy, skill, and now, AI.",
      },
      {
        type: "paragraph",
        text: "Every solved ticket is a small victory in keeping customer trust alive.",
      },

      { type: "subheading", text: "🔥 1. Calm in Chaos" },
      {
        type: "paragraph",
        text: "In the middle of a crisis, support engineers stay collected, listening and acting with precision.",
      },
      {
        type: "paragraph",
        text: "AI can help filter the noise, but it's your decision-making that turns chaos into calm.",
      },

      { type: "subheading", text: "🛠 2. Tools of the Trade" },
      {
        type: "paragraph",
        text: "With AI dashboards, predictive analytics, and auto summaries, they can focus on what truly matters — solutions.",
      },
      {
        type: "paragraph",
        text: "paragraph Every new AI feature should be seen as a tool in your belt, not a threat to your role.",
      },

      {
        type: "subheading",
        text: "💭 Self Reflection: Are You Leveraging AI Enough?",
      },
      {
        type: "paragraph",
        text: "Ask yourself: Am I still doing tasks manually that AI could do better and faster? Every minute you save is a minute you can use to deepen customer relationships.",
      },

      {
        type: "subheading",
        text: "📊 Productivity Mindset for Frontline Heroes",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "paragraph",
        text: "Technology will evolve, but the courage and care of the human on the front line will always be irreplaceable.",
      },
      {
        type: "paragraph",
        text: "When AI handles the grunt work, you're free to be the calm, empathetic problem solver customers trust.",
      },
    ],
    category: "Elevate Your Support",
  },
  {
    ...
    content: [
      ...
      {
        type: "paragraph",
        text: "AI can predict problems, suggest solutions, and automate workflows — but human insight completes the picture.",
      },
      {
        type: "paragraph",
        text: "This partnership transforms support from reactive problem solving to proactive customer care.",
      },

      { type: "subheading", text: "🔍 1. Anticipating Issues" },
      {
        type: "paragraph",
        text: "Predictive AI can warn about common issues before customers even report them.",
      },
      {
        type: "paragraph",
        text: "Imagine being able to send a fix or helpful resource before the customer even realizes there's a problem.",
      },

      { type: "subheading", text: "💬 2. Personalizing Responses" },
      {
        type: "paragraph",
        text: "AI drafts the message, but humans add the warmth and understanding that makes it land.",
      },
      {
        type: "paragraph",
        text: "The tone you choose, the empathy you display — that's what makes the customer feel heard, not just answered.",
      },

      { type: "subheading", text: "🧠 3. Continuous Self Analysis" },
      {
        type: "paragraph",
        text: "Review how you interact with AI daily. Are you accepting its suggestions blindly, or refining them for maximum customer impact?",
      },

      {
        type: "subheading",
        text: "📌 Productivity Playbook for the AI Enhanced Future",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "paragraph",
        text: "The real magic isn't in AI or humans alone — it's in their partnership, elevating the customer experience to new heights.",
      },
      {
        type: "paragraph",
        text: "Future proof your role by mastering both — the tech that predicts and the empathy that connects.",
      },
    ],
    category: "Secret to Elevate Experience",
  },
