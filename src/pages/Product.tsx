		...
		<main>
					...
					<div className="grid gap-12 lg:grid-cols-2 items-center">
						...
						<div>
							...
							<p className="text-lg text-muted-foreground mb-6">
								AI-powered solution for support engineers: reduce the time
								spent searching for the right article, drafting ticket
								responses, and finding the correct POC to assign tickets. No
								more endless tab-switching—everything you need in one place.
							</p>
							<Button
								variant="hero"
								size="lg"
						...
						<div className="relative">
							<div
								className="relative aspect-video rounded-2xl overflow-hidden bg-gradient-to-br from-slate-900 to-slate-800 shadow-2xl cursor-pointer"
				...
				<Card>
					...
					<CardContent className="text-muted-foreground">
						<ul className="space-y-2">
							...
							<li className="flex items-center gap-2">
								<CheckCircle2 className="h-5 w-5 text-primary" /> Zoho Desk{" "}
								<span className="text-xs text-muted-foreground ml-1">
									(coming soon)
								</span>
							</li>
							<li className="flex items-center gap-2">
								<CheckCircle2 className="h-5 w-5 text-primary" /> Zendesk{" "}
								<span className="text-xs text-muted-foreground ml-1">
									(coming soon)
								</span>
							</li>
			...
			<section className="container mx-auto px-4 pb-20">
              ...
              Draft emails directly from articles: Help Dude uses the selected article as a base, and support engineers can also describe the issue and solution to generate a tailored email draft. The system finds the correct POC to assign the ticket, and lets support engineers adjust the tone, language, and length of the draft as needed.
						...
						<ul className="mt-4 space-y-2 text-muted-foreground">
							...
							<li>
								Also drafts emails based on support engineer-provided issue
								and solution
							</li>
							<li>Finds and assigns the correct POC for the ticket</li>
							<li>
								Allows support engineers to change tone, language, and length
								of the draft
							</li>
			...
			<section className="container mx-auto grid items-center gap-8 px-4 pb-20 md:grid-cols-2">
				...
				<div>
					...
					<p className="mt-2 text-muted-foreground">
						This is the admin page where all configuration must be done —
						articles, POCs, and workflows that power Help Dude.
					</p>
